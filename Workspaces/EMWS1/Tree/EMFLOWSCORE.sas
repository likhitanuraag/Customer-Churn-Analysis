...
_ARBFMT_3 = PUT( Churned , $3.);
 %DMNORMCP( _ARBFMT_3, F_Churned );
...
*****  RESIDUALS R_ *************;
IF  F_Churned  NE 'YES'
AND F_Churned  NE 'NO'  THEN DO;
        R_ChurnedYes  = .;
        R_ChurnedNo  = .;
 END;
 ELSE DO;
       R_ChurnedYes  =  -P_ChurnedYes ;
       R_ChurnedNo  =  -P_ChurnedNo ;
       SELECT( F_Churned  );
          WHEN( 'YES'  ) R_ChurnedYes  = R_ChurnedYes  +1;
          WHEN( 'NO'  ) R_ChurnedNo  = R_ChurnedNo  +1;
       END;
 END;
